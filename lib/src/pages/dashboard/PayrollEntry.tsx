        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1px] p-[1px] border-t border-black bg-border/50">
          ...
          <div className="bg-card text-[#1C2B33] shadow-sm border-r border-black">
            ...
            <div className="p-3 space-y-2">
              ...
              {/* OT rows - label | hours input | total amount read-only */}
              <div className="grid grid-cols-[120px_1fr_90px_100px] gap-2 items-center">
                ...
                <Input
                  className="h-6 text-xs bg-white font-black text-[#1C2B33] px-2 text-right tabular-nums border-black"
                  value={otRegDayHours ? formatNumber(parseInput(otRegDayAmount) * parseInput(otRegDayHours)) : ''}
                  readOnly
                />
              </div>
              <div className="grid grid-cols-[120px_1fr_90px_100px] gap-2 items-center">
                ...
                <Input
                  className="h-6 text-xs bg-white font-black text-[#1C2B33] px-2 text-right tabular-nums border-black"
                  value={otSundayHours ? formatNumber(parseInput(otSundayAmount) * parseInput(otSundayHours)) : ''}
                  readOnly
                />
              </div>
              <div className="grid grid-cols-[120px_1fr_90px_100px] gap-2 items-center">
                ...
                <Input
                  className="h-6 text-xs bg-white font-black text-[#1C2B33] px-2 text-right tabular-nums border-black"
                  value={otSpecialHours ? formatNumber(parseInput(otSpecialAmount) * parseInput(otSpecialHours)) : ''}
                  readOnly
                />
              </div>
              <div className="grid grid-cols-[120px_1fr_90px_100px] gap-2 items-center">
                ...
                <Input
                  className="h-6 text-xs bg-white font-black text-[#1C2B33] px-2 text-right tabular-nums border-black"
                  value={otLegalHours ? formatNumber(parseInput(otLegalAmount) * parseInput(otLegalHours)) : ''}
                  readOnly
                />
              </div>
              <div className="grid grid-cols-[120px_1fr_90px_100px] gap-2 items-center">
                ...
                <Input
                  className="h-6 text-xs bg-white font-black text-[#1C2B33] px-2 text-right tabular-nums border-black"
                  value={otNdHours ? formatNumber(parseInput(otNdAmount) * parseInput(otNdHours)) : ''}
                  readOnly
                />
              </div>
